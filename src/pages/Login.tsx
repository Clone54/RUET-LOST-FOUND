  ...
  const handleGoogleLogin = () => {
    signInWithGoogle().catch((err) => {
      ...
      if (err.message && err.message.includes('popup')) {
        setError('Google sign-in popup was blocked or closed. If you are in the preview iframe, please open the app in a new tab (using the arrow icon in the top right) to use Google Sign-in.');
      } else {
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center py-2 px-4 border border-slate-300 rounded-md shadow-sm bg-white text-sm font-medium text-slate-700 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
